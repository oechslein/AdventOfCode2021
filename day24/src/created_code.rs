...
pub fn calc_part1() -> Option<i64> {
    ...
    let (x, y, z, w) = (0, 0, 0, 0);
    for input_01 in (1..=9).rev() {
        let (x, y, z, w) = calc_part1_step_01(input_01, x, y, z, w);
        if known_not_working_01.contains(&(x, y, z, w)) {
            continue;
        }
        for input_02 in (1..=9).rev() {
            let (x, y, z, w) = calc_part1_step_02(input_02, x, y, z, w);
            if known_not_working_02.contains(&(x, y, z, w)) {
                continue;
            }
            for input_03 in (1..=9).rev() {
                let (x, y, z, w) = calc_part1_step_03(input_03, x, y, z, w);
                if known_not_working_03.contains(&(x, y, z, w)) {
                    continue;
                }
                for input_04 in (1..=9).rev() {
                    let (x, y, z, w) = calc_part1_step_04(input_04, x, y, z, w);
                    if known_not_working_04.contains(&(x, y, z, w)) {
                        continue;
                    }
                    for input_05 in (1..=9).rev() {
                        let (x, y, z, w) = calc_part1_step_05(input_05, x, y, z, w);
                        if known_not_working_05.contains(&(x, y, z, w)) {
                            continue;
                        }
                        for input_06 in (1..=9).rev() {
                            let (x, y, z, w) = calc_part1_step_06(input_06, x, y, z, w);
                            if known_not_working_06.contains(&(x, y, z, w)) {
                                continue;
                            }
                            for input_07 in (1..=9).rev() {
                                let (x, y, z, w) = calc_part1_step_07(input_07, x, y, z, w);
                                if known_not_working_07.contains(&(x, y, z, w)) {
                                    continue;
                                }
                                for input_08 in (1..=9).rev() {
                                    let (x, y, z, w) = calc_part1_step_08(input_08, x, y, z, w);
                                    if known_not_working_08.contains(&(x, y, z, w)) {
                                        continue;
                                    }
                                    for input_09 in (1..=9).rev() {
                                        let (x, y, z, w) = calc_part1_step_09(input_09, x, y, z, w);
                                        if known_not_working_09.contains(&(x, y, z, w)) {
                                            continue;
                                        }
                                        for input_10 in (1..=9).rev() {
                                            let (x, y, z, w) =
                                                calc_part1_step_10(input_10, x, y, z, w);
                                            if known_not_working_10.contains(&(x, y, z, w)) {
                                                continue;
                                            }
                                            for input_11 in (1..=9).rev() {
                                                let (x, y, z, w) =
                                                    calc_part1_step_11(input_11, x, y, z, w);
                                                if known_not_working_11.contains(&(x, y, z, w)) {
                                                    continue;
                                                }
                                                for input_12 in (1..=9).rev() {
                                                    let (x, y, z, w) =
                                                        calc_part1_step_12(input_12, x, y, z, w);
                                                    if known_not_working_12.contains(&(x, y, z, w))
                                                    {
                                                        continue;
                                                    }
                                                    for input_13 in (1..=9).rev() {
                                                        let (x, y, z, w) = calc_part1_step_13(
                                                            input_13, x, y, z, w,
                                                        );
                                                        if known_not_working_13
                                                            .contains(&(x, y, z, w))
                                                        {
                                                            continue;
                                                        }
                                                        for input_14 in (1..=9).rev() {
                                                            let (x, y, z, w) = calc_part1_step_14(
                                                                input_14, x, y, z, w,
                                                            );
                                                            if z == 0 {
                                                                return Some(
                                                                    input_01 * 10_i64.pow(13)
                                                                        + input_02 * 10_i64.pow(12)
                                                                        + input_03 * 10_i64.pow(11)
                                                                        + input_04 * 10_i64.pow(10)
                                                                        + input_05 * 10_i64.pow(9)
                                                                        + input_06 * 10_i64.pow(8)
                                                                        + input_07 * 10_i64.pow(7)
                                                                        + input_08 * 10_i64.pow(6)
                                                                        + input_09 * 10_i64.pow(5)
                                                                        + input_10 * 10_i64.pow(4)
                                                                        + input_11 * 10_i64.pow(3)
                                                                        + input_12 * 10_i64.pow(2)
                                                                        + input_13 * 10_i64.pow(1)
                                                                        + input_14 * 10_i64.pow(0),
                                                                );
                                                            }
                                                        }
